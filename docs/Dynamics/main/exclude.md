...
The `nav_exclude` parameter does not affect the [breadcrumbs]({% link docs/Dynamics/inverse_dynamics.md %}), nor the [lists of child pages]({% link docs/Dynamics/equations_of_motion.md %}), which you can use to access pages excluded from the main navigation.
